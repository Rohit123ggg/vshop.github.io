...
move_uploaded_file($_FILES['image']['tmp_name'],"addhead/$image");
$modelno=$_POST['modelno'];
$description=$_POST['description'];

$ins="insert into head ( image, product, descr)
 ...
 if($insertstatus)
 {
     echo "<script>alert('succes');location.href='headset.php?'</script>"; 
 }else
 {
...
<body>
    ...
    <div class="container">
        <div class="row"> 
        <h3 class="text-white text-center mt-2">Add Headset Details</h3>
...
?>
        ...
        <td><img src="addhead/<?php echo $row['image'] ?>" width="50" height="50" ></td>
        ...
        <td><a class="btn btn-danger" href="hdelete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
